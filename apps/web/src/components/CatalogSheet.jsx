                      ...
                      {song.sections.map(section => {
                        ...
                        return (
                          <button
                            ...
                            className={`group flex items-center justify-between gap-1.5 rounded-lg border px-2.5 py-2 text-left transition active:scale-[0.99] ${active
                          ...
                          >
                            <div className="min-w-0">
                              ...
                              <div className={`mt-0.5 text-[10px] leading-tight ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
