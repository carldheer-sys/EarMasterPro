 ...
 * 
 * Tests the useScaleDegreeAnalysis hook against various keys and modes
 * Verifies that scale degrees are calculated correctly using modulo arithmetic
 */

import { useScaleDegreeAnalysis } from '../src/hooks/useScaleDegreeAnalysis'
...
const cMajorAnalysis = useScaleDegreeAnalysis(cMajorNotes, 'C', 'Major')
...
const cMajorChromAnalysis = useScaleDegreeAnalysis(cMajorChromNotes, 'C', 'Major')
...
const gMajorAnalysis = useScaleDegreeAnalysis(gMajorNotes, 'G', 'Major')
...
const dMajorAnalysis = useScaleDegreeAnalysis(dMajorNotes, 'D', 'Major')
...
const aMinorAnalysis = useScaleDegreeAnalysis(aMinorNotes, 'A', 'Minor')
...
const eMinorAnalysis = useScaleDegreeAnalysis(eMinorNotes, 'E', 'Minor')
...
const fSharpMajorAnalysis = useScaleDegreeAnalysis(fSharpMajorNotes, 'F#', 'Major')
...
const chromaticAnalysis = useScaleDegreeAnalysis(chromaticNotes, 'C', 'Major')
...
const bbMajorAnalysis = useScaleDegreeAnalysis(bbMajorNotes, 'A#', 'Major')
...
const cSharpMinorAnalysis = useScaleDegreeAnalysis(cSharpMinorNotes, 'C#', 'Minor')
...
const octaveAnalysis = useScaleDegreeAnalysis(octaveNotes, 'C', 'Major')
...
const nonDiatonicMajorAnalysis = useScaleDegreeAnalysis(nonDiatonicMajor, 'C', 'Major')
...
const nonDiatonicMinorAnalysis = useScaleDegreeAnalysis(nonDiatonicMinor, 'A', 'Minor')
